...
const OperationGreeterServiceSayHello = "/GreeterService/SayHello"
...
func RegisterGreeterServiceHTTPServer(s *http.Server, srv GreeterServiceHTTPServer) {
	r := s.Route("/")
	r.POST("/v1/hello", _GreeterService_SayHello0_HTTP_Handler(srv))
}
...
func (c *GreeterServiceHTTPClientImpl) SayHello(ctx context.Context, in *HelloRequest, opts ...http.CallOption) (*HelloResponse, error) {
